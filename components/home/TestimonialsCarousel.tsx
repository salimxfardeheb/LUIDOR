...
import type { HomeTestimonial } from "@/lib/home/queries";
import { cn } from "@/lib/utils";

/**
 * Carousel de témoignages.
 *
 * Trois cartes sont visibles simultanément sur grand écran, où la liste passe
 * en grille ; le carousel ne s'active qu'en dessous, là où une seule carte tient
 * à l'écran. Flèches et pastilles disparaissent avec un témoignage unique :
 * elles ne mèneraient nulle part.
 *
 * Les témoignages viennent de la base (`getHomeTestimonials`) et sont fournis
 * par `Testimonials`, qui garantit que la liste n'est jamais vide.
 */
