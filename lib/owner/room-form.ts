...
export const ROOM_FORM_STEPS: readonly RoomFormStep[] = [
  {
    ...
    label: "La salle",
    description:
      "Le nom, la description, l'adresse, la capacité et les espaces : ce que les clients verront en premier.",
    fields: [
      "name",
      "description",
      "city",
  ...
  },
  {
    ...
    description:
      "Le prix d'appel, le détail de vos formules, et les conditions que le client accepte en réservant.",
    fields: [
      "basePrice",
      "rates",
      "depositAmount",
  ...
  },
  {
    ...
    fields: ["photos", "videoUrl", "equipments", "services"],
  },
] as const;
...
export const ROOM_FIELD_LABELS: Record<string, string> = {
  ...
  surfaceM2: "Superficie",
  spacesCount: "Nombre d'espaces",
  basePrice: "Prix de base",
  depositAmount: "Caution",
  cleaningFee: "Frais de ménage",
  cancellationPolicy: "Politique d'annulation",
  cancellationTerms: "Conditions complètes",
  openingHours: "Horaires d'utilisation",
  musicPolicy: "Sonorisation",
  videoUrl: "Visite vidéo",
